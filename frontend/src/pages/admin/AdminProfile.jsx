    ...
    return (
        <div className="space-y-6 max-w-5xl mx-auto">
            <div className="flex justify-between items-center">
                <h1 className="text-[20px] sm:text-[24px] lg:text-[30px] font-medium text-black tracking-tight leading-none">My Profile</h1>
                <Link
                    to={`/${user?.restaurantName?.toLowerCase()?.replace(/\s+/g, '-') || 'restaurant'}/admin/settings`}
                    className="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full font-medium flex items-center gap-2 transition-colors shadow-sm"
                >
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-8">
                    <div className="relative shrink-0">
                        <div className="w-32 h-32 rounded-full bg-orange-50 border-4 border-white shadow-lg overflow-hidden flex items-center justify-center">
                            <span className="text-4xl font-medium text-[#FD6941]">
                    ...
                    <div className="flex-1 text-center md:text-left space-y-2">
                        <h2 className="text-2xl font-medium text-gray-800">{profile.fullName}</h2>
                    ...
                    <div className="shrink-0 w-full md:w-auto">
                        <button
                            ...
                            className="w-full md:w-auto px-6 py-3 bg-red-50 hover:bg-red-100 text-red-500 rounded-xl text-sm font-medium flex items-center justify-center gap-2 transition-colors"
                        >
                ...
                <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                        ...
                        <div className="space-y-1">
                            <label className="text-xs font-medium text-gray-400 uppercase tracking-wider">Restaurant Name</label>
                            <div className="flex items-center gap-3 text-gray-700 font-medium">
                                <div className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-400">
                        ...
                        <div className="space-y-1">
                            <label className="text-xs font-medium text-gray-400 uppercase tracking-wider">Registered Address</label>
                            <div className="flex items-center gap-3 text-gray-700 font-medium">
                                <div className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-400">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                        <p className="text-xs text-gray-400">
                            Need to update these details? <Link to={`/${user?.restaurantName?.toLowerCase()?.replace(/\s+/g, '-') || 'restaurant'}/admin/settings`} className="text-[#FD6941] font-medium hover:underline">Go to Settings</Link>
                        </p>
                    </div>
                </div>
            </div>
